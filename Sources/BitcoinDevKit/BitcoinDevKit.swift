...
public protocol FullScanRequestProtocol : AnyObject {
    ...
    func inspectSpksForAllKeychains(inspector: FullScanScriptInspector) throws  -> FullScanRequest
...
open func inspectSpksForAllKeychains(inspector: FullScanScriptInspector)throws  -> FullScanRequest {
    return try  FfiConverterTypeFullScanRequest.lift(try rustCallWithError(FfiConverterTypeInspectError.lift) {
    uniffi_bdkffi_fn_method_fullscanrequest_inspect_spks_for_all_keychains(self.uniffiClonePointer(),
        ...
        inspect: { (
            ...
            let makeCall = {
                ...
                return uniffiObj.inspect(
                     ...
                     script: try FfiConverterTypeScript.lift(script)
                )
            }
...
public protocol SyncRequestProtocol : AnyObject {
    ...
    func inspectSpks(inspector: SyncScriptInspector) throws  -> SyncRequest
...
open func inspectSpks(inspector: SyncScriptInspector)throws  -> SyncRequest {
    return try  FfiConverterTypeSyncRequest.lift(try rustCallWithError(FfiConverterTypeInspectError.lift) {
    uniffi_bdkffi_fn_method_syncrequest_inspect_spks(self.uniffiClonePointer(),
...
open func feeAbsolute(fee: Amount) -> TxBuilder {
    ...
    uniffi_bdkffi_fn_method_txbuilder_fee_absolute(self.uniffiClonePointer(),
        FfiConverterTypeAmount.lower(fee),$0
    )
})
}
...
public convenience init(descriptor: Descriptor, changeDescriptor: Descriptor?, persistenceBackendPath: String, network: Network)throws  {
    let pointer =
        try rustCallWithError(FfiConverterTypeWalletCreationError.lift) {
...
public static func newNoPersist(descriptor: Descriptor, changeDescriptor: Descriptor?, network: Network)throws  -> Wallet {
    return try  FfiConverterTypeWallet.lift(try rustCallWithError(FfiConverterTypeDescriptorError.lift) {
...
open func calculateFee(tx: Transaction)throws  -> UInt64 {
    return try  FfiConverterUInt64.lift(try rustCallWithError(FfiConverterTypeCalculateFeeError.lift) {
...
open func calculateFeeRate(tx: Transaction)throws  -> FeeRate {
    return try  FfiConverterTypeFeeRate.lift(try rustCallWithError(FfiConverterTypeCalculateFeeError.lift) {
...
open func commit()throws  -> Bool {
    return try  FfiConverterBool.lift(try rustCallWithError(FfiConverterTypePersistenceError.lift) {
    uniffi_bdkffi_fn_method_wallet_commit(self.uniffiClonePointer(),$0
    )
})
}
    
open func getBalance() -> Balance {
...
open func revealNextAddress(keychain: KeychainKind)throws  -> AddressInfo {
    return try  FfiConverterTypeAddressInfo.lift(try rustCallWithError(FfiConverterTypePersistenceError.lift) {
...
open func startFullScan() -> FullScanRequest {
    return try!  FfiConverterTypeFullScanRequest.lift(try! rustCall() {
    uniffi_bdkffi_fn_method_wallet_start_full_scan(self.uniffiClonePointer(),$0
    )
})
}
    
open func startSyncWithRevealedSpks() -> SyncRequest {
    return try!  FfiConverterTypeSyncRequest.lift(try! rustCall() {
...
public enum AddressError {
    ...
    case NetworkValidation(required: Network, found: Network, address: String
    )
...
public enum ChainPosition {
    ...
    case confirmed(height: UInt32, timestamp: UInt64
    )
...
public struct FfiConverterTypeChainPosition: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ChainPosition {
        ...
        case 1: return .confirmed(height: try FfiConverterUInt32.read(from: &buf), timestamp: try FfiConverterUInt64.read(from: &buf)
        )
...
public struct FfiConverterTypeInspectError: FfiConverterRustBuffer {
    typealias SwiftType = InspectError

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> InspectError {
        let variant: Int32 = try readInt(&buf)
        switch variant {
    ...
    public static func write(_ value: InspectError, into buf: inout [UInt8]) {
        switch value {
...
extension InspectError: Equatable, Hashable {}

extension InspectError: Error { }
...
public enum ParseAmountError {
    ...
    case UnknownDenomination(errorMessage: String
    )
    case PossiblyConfusingDenomination(errorMessage: String
    )
...
public enum SignerError {
    ...
    case InvalidSighash
    case SighashError(errorMessage: String
    )
    case MiniscriptPsbt(errorMessage: String
    )
...
public enum SqliteError {
    ...
    case invalidNetwork(expected: Network, given: Network
    )
...
public struct FfiConverterTypeSqliteError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SqliteError {
        ...
        case 1: return .invalidNetwork(expected: try FfiConverterTypeNetwork.read(from: &buf), given: try FfiConverterTypeNetwork.read(from: &buf)
        )
        
        case 2: return .sqlite(rusqliteError: try FfiConverterString.read(from: &buf)
        )
    ...
    public static func write(_ value: SqliteError, into buf: inout [UInt8]) {
        ...
        case let .invalidNetwork(expected,given):
            writeInt(&buf, Int32(1))
            FfiConverterTypeNetwork.write(expected, into: &buf)
            FfiConverterTypeNetwork.write(given, into: &buf)
...
public enum WalletCreationError {
    ...
    case InvalidMagicBytes(got: [UInt8], expected: [UInt8]
    )
    case Descriptor
    case Persist(errorMessage: String
    )
    ...
    case LoadedDescriptorDoesNotMatch(got: String, keychain: KeychainKind
    )
...
private var initializationResult: InitializationResult {
    ...
    if (uniffi_bdkffi_checksum_method_fullscanrequest_inspect_spks_for_all_keychains() != 25425) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_bdkffi_checksum_method_syncrequest_inspect_spks() != 30396) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_bdkffi_checksum_method_txbuilder_fee_absolute() != 964) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_bdkffi_checksum_constructor_address_from_script() != 36835) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_bdkffi_checksum_constructor_address_new() != 56943) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_bdkffi_checksum_constructor_amount_from_btc() != 44722) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_bdkffi_checksum_constructor_amount_from_sat() != 14958) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_bdkffi_checksum_constructor_bumpfeetxbuilder_new() != 63012) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_bdkffi_checksum_constructor_derivationpath_new() != 6139) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_bdkffi_checksum_constructor_descriptor_new() != 12856) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_bdkffi_checksum_constructor_descriptor_new_bip44() != 2218) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_bdkffi_checksum_constructor_descriptor_new_bip44_public() != 48469) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_bdkffi_checksum_constructor_descriptor_new_bip49() != 37902) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_bdkffi_checksum_constructor_descriptor_new_bip49_public() != 48787) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_bdkffi_checksum_constructor_descriptor_new_bip84() != 52564) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_bdkffi_checksum_constructor_descriptor_new_bip84_public() != 63630) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_bdkffi_checksum_constructor_descriptor_new_bip86() != 65525) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_bdkffi_checksum_constructor_descriptor_new_bip86_public() != 40331) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_bdkffi_checksum_constructor_descriptorsecretkey_new() != 8359) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_bdkffi_checksum_constructor_feerate_from_sat_per_kwu() != 43867) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_bdkffi_checksum_constructor_feerate_from_sat_per_vb() != 2874) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_bdkffi_checksum_constructor_wallet_new() != 57192) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_bdkffi_checksum_constructor_wallet_new_no_persist() != 21860) {
        return InitializationResult.apiChecksumMismatch
    }
